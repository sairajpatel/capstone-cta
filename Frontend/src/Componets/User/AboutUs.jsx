...
import SairajImage from '../../../public/Images/Sairaj.jpg'
const AboutUs = () => {
  return (
      ...
      <div className="w-full max-w-7xl mx-auto px-3 py-4 md:px-6 md:py-8">
        ...
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="text-sm md:text-lg text-gray-300 max-w-xl mx-auto px-2">
            Your premier destination for discovering and creating unforgettable
            events
          </p>
        </div>
        ...
        <div className="flex flex-col gap-6 md:gap-8 mb-8 md:mb-12">
          ...
          <div className="bg-[#2B293D] rounded-lg p-4 md:p-6 shadow-xl">
            ...
            <p className="text-sm md:text-base text-gray-300 leading-relaxed">
              At GatherGuru, we believe in the power of bringing people
              together. Our platform is designed to make event planning and
              discovery seamless, allowing organizers to create memorable
              experiences and attendees to find events that spark their
              interest.
            </p>
          </div>
        </div>
        ...
        <div className="mb-8 md:mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            <div className="bg-[#2B293D] p-4 md:p-6 rounded-lg shadow-xl">
              <div className="text-yellow-400 text-xl md:text-2xl mb-2 md:mb-3">
                🎯
              </div>
